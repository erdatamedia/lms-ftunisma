    ...
    <ProtectedRoute allowedRoles={['ADMIN']}>
      <DashboardShell>
        <PageCard
          ...
          description="Rekap kelas untuk admin."
        >
          <Link
          ...
          {data && (
            <div className="space-y-6">
              ...
              <SectionCard
                ...
                subtitle="Rekap aktivitas setiap meeting."
              >
                <div className="grid gap-3">
                  ...
                  {!loading && data.meetings?.length === 0 && (
                    <EmptyState text="Belum ada data meeting." />
                  )}
                </div>
              </SectionCard>

              <SectionCard
                title="Ringkasan Assignment"
                subtitle="Rekap tugas, submission, dan rata-rata nilai."
              >
                <div className="grid gap-3">
                  ...
                  {!loading && data.assignments?.length === 0 && (
                    <EmptyState text="Belum ada data assignment." />
                  )}
                </div>
              </SectionCard>
              ...
              <SectionCard
                ...
                subtitle="Ringkasan performa mahasiswa aktif pada kelas ini."
              >
                <div className="grid gap-3">
                  ...
                  {!loading && data.students?.length === 0 && (
                    <EmptyState text="Belum ada data mahasiswa aktif." />
                  )}
                </div>
              </SectionCard>
            </div>
